...
const SocialShare = ({ url, onClose }) => {
  ...
  const handleCopy = () => {
    toast("Link copied. Share to earn !", {
      position: "top-center",
    });
    setIsCopied(true);
    setTimeout(function () {
        ...
        <div className="bg-gray-100 w-full mx-4 p-4 rounded-xl ">
          ...
          <div className="my-4">
            ...
            <Link
              ...
              class="max-w-[240px] mt-4 flex rounded-full mx-auto bg-gradient-to-tr from-red-400 via-orange-400 to-rose-400 p-1 shadow-lg"
            >
              <button class="flex-1 font-bold text-xl bg-white px-6 py-1 rounded-full">
                Referral History
              </button>
            </Link>
          </div>
